...
namespace StorybrewScripts
{
    public class Particles : StoryboardObjectGenerator
    {
        ...
        private void GenerateParticles(double startTime, double endTime, double particleDuration, int particleCount, string filePath = "sb/particle.png", float scale = 0.02f, double opacity = 1)
        {
        ...
        {
            using (var pool = new OsbSpritePool(GetLayer("Particles"), "sb/particle.png", OsbOrigin.Centre, (sprite, starttime, endtime) => { }))
            {
